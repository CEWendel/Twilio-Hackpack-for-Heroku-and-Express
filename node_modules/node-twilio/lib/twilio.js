...
Client.prototype.getApps = function(opts){
    console.log("get apps called");
    return new Application(this);
}

Client.prototype.newApp = function(name, opts) {
    console.log('Attempting to make new app with name ' + name);
    return new Application(this, name, opts);
}

function Application(client, name, opts) {
    console.log("new app");
    var self = this;
    this.client = client;
    params = {
    ...
    //self.client.getApplications();
    self.client.updateApplicationInfo(params)
}

Client.prototype.getAcctInfo = function(opts) {
    //var self = this;
    console.log('client.getAccountInfo called');
    return new AccountInfo(this);
}

function AccountInfo(client, opts) {
    console.log("New account info");
    var self = this;
    this.client = client;
    self.client.getAccountInfo();
}
...
Client.prototype.getPhoneNumber = function(num, opts) {
    console.log('Get phone number called');
...
function PhoneNumber(client, num, opts) {
    ...
    if(num.match(/^PN/)) {
        this.attrs.sid = num;
        console.log('this.attrs.sid is ' + this.attrs.sid);
    } else {
        this.attrs.phoneNumber = num;
        console.log('this.attrs.phoneNumber is ' + this.attrs.phoneNumber);
    }
    ...
    this.on('newListener', function(listener) {
        ...
        console.log('about to call updateIncomingNumber...');
